...
export const stats: Stat[] = [
	{
		value: '5+',
		label: 'Years of dedicated local service across the archipelago.',
	},
	{ value: '2,500+', label: 'Travelers who have discovered Banggai with us.' },
	{
		value: '15+',
		label: 'Exclusive destinations brought into custom itineraries.',
	},
	{
		value: '100%',
		label: 'Born, raised, and operated by Banggai native guides.',
	},
];
