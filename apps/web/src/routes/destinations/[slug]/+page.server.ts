 ...
 * duplicates removed. Now that both sides are resolved to the same kind of URL, de-duplication
 * works by identity — the gallery of a lake page shows other destinations' photographs, and
 * the filter is what stops the same photograph appearing twice in six tiles.
 */
