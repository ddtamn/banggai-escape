...
export const destinations: Destination[] = [
	...
	},
	{
		...
		experiences: [
			{ title: 'Forest Swim', text: 'Cool, clear spring water surrounded by old-growth canopy.' },
			{ title: 'Shaded Trail Walk', text: 'A short walk in with local birdlife and ferns along the path.' },
			{ title: 'Quiet Picnic', text: 'A simple picnic spot away from the main lake crowds.' }
		],
	...
	},
	{
		...
		experiences: [
			{ title: 'Plunge Pool Swim', text: 'A broad, deep pool directly beneath the main tier.' },
			{ title: 'Cascade Trail', text: 'Follow the stream up to find the smaller upper tiers.' },
			{ title: 'Rainforest Photography', text: 'Dappled light through the canopy above the falls.' }
		],
	...
	},
	{
		...
		experiences: [
			{ title: 'Shallow Swimming', text: 'A gently shelving sandy bottom that stays calm in most conditions.' },
			{ title: 'Sunset Walk', text: 'The crescent faces west, making it the best sunset beach nearby.' },
			{ title: 'Beach Picnic', text: 'Shade trees and flat sand make this the easiest picnic stop.' }
		],
	...
	},
	{
		...
		experiences: [
			{ title: 'Reef Flat Snorkel', text: 'Calm, shallow reef with coral heads and reef fish in easy reach.' },
			{ title: 'Swim Between Islands', text: 'A short channel crossing at slack tide for confident swimmers.' },
			{ title: 'Turtle Grass Beds', text: 'Seagrass shallows where green turtles are regularly seen grazing.' }
		],
	...
	},
	{
		...
		experiences: [
			{ title: 'Cliff Anchorage', text: 'Sheltered water beneath vertical limestone walls.' },
			{ title: 'Deep Water Snorkel', text: 'Steep reef that drops away quickly into blue water.' },
			{ title: 'Karst Photography', text: 'High-contrast rock and water from the boat or the shallows.' }
		],
	...
	},
	{
		...
		experiences: [
			{ title: 'Emerald Pool Swim', text: 'A deep, cool pool directly beneath the falls.' },
			{ title: 'Grove Walk', text: 'Pass clove and coffee smallholdings on the way in.' },
			{ title: 'Mossy Rock Amphitheatre', text: 'A wide rock shelf that makes the falls feel almost architectural.' }
		],
	...
	},
	{
		...
		experiences: [
			{ title: 'Working Waterfront', text: 'Watch cargo, produce, and passengers load for the islands.' },
			{ title: 'Harbor Street Food', text: 'Simple warung food at the quay, best in the early morning.' },
			{ title: 'Boat Spotting', text: 'Traditional ketinting and modern speedboats side by side.' }
		],
	...
	},
	{
		...
		experiences: [
			{ title: 'Ridge Panorama', text: 'Wide views across the strait to the outer island chain.' },
			{ title: 'Highland Villages', text: 'Coffee, clove, and hospitality in villages off the coastal road.' },
			{ title: 'Birdlife Walks', text: 'Early walks with a local spotter for hornbills and kingfishers.' }
		],
