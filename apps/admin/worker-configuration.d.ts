/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.types` (hash: 3efde5cb6e0a6f7a9f7fa6be76d0a8a5)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MEDIA_PUBLIC_URL">> {}
}
